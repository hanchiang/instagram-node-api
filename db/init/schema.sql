CREATE TABLE `user` (
  ...
  `num_following` smallint(6) NOT NULL,
  `average_likes` float(20,1) NOT NULL,
  `average_comments` float(20,1) NOT NULL COMMENT 'limit is 7500',
  ...
  `business_category_name` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `business_email` varchar(320) COLLATE utf8_unicode_ci DEFAULT NULL,
  `business_phone_number` varchar(15) COLLATE utf8_unicode_ci DEFAULT NULL,
  `business_address_json` json DEFAULT NULL,
  `rhx_gis` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
